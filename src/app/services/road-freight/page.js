...
const roadFreightJsonLd = {
  ...
  "description": "Comprehensive road freight services with flexible delivery solutions and dedicated fleet management.",
  "areaServed": "Worldwide",
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
    "name": "Road Freight Solutions",
    "itemListElement": [
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Service",
          "name": "Full Truckload Services",
          "description": "Dedicated truck transportation for large shipments"
        }
      },
      {
        "@type": "Offer",
...
const RoadFreight = () => {
  ...
  return (
    <>
      <Script
        id="road-freight-jsonld"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(roadFreightJsonLd) }}
      />
      <div>
