...
const technologyJsonLd = {
  ...
  "@type": "Service",
  "name": "Technology Logistics Services",
  "provider": {
    "@type": "Organization",
    "name": "Barta Logistics",
    "url": "https://bartalogistics.com"
  },
  "description": "Specialized logistics solutions for technology sector, including sensitive electronic equipment handling and IT infrastructure transport.",
    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "Secure transportation of sensitive electronic equipment"
        }
      },
      {
        "@type": "Offer",
        "itemOffered": {
          "@type": "Service",
          "name": "Data Center Logistics",
          "description": "Specialized solutions for data center equipment"
        }
      }
    ]
  }
