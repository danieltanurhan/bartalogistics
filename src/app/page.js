        ...
        <div className="home-content-container">
          ...
          <div className="industries-grid">
            ...
            <div className="industry-card">
              <div
                className="industry-image"
                style={{ backgroundImage: "url('/images/automotive.jpg')" }}
              >
                <div className="industry-icon">
                  <img
                    src="/images/icons/automotive-icon.svg"
                    alt="Automotive Icon"
                  />
                </div>
              </div>
            ...
            <div className="industry-card">
              ...
              >
                <div className="industry-icon">
                  <img
                    src="/images/icons/technology-icon.svg"
                    alt="Technology Icon"
                  />
                </div>
              </div>
            ...
            <div className="industry-card">
              <div
                className="industry-image"
                style={{ backgroundImage: "url('/images/consumer-goods.jpg')" }}
              >
                <div className="industry-icon">
                  <img
                    src="/images/icons/retail-icon.svg"
            ...
            <div className="industry-card">
              ...
              >
                <div className="industry-icon">
                  <img
                    src="/images/icons/defense-icon.svg"
                    alt="Defense Icon"
                  />
                </div>
              </div>
            ...
            <div className="industry-card">
              <div
                className="industry-image"
                style={{ backgroundImage: "url('/images/chemicals.jpg')" }}
              >
                <div className="industry-icon">
                  <img
                    src="/images/icons/chemicals-icon.svg"
                    alt="Chemicals Icon"
                  />
                </div>
              </div>
            ...
            <div className="industry-card">
              <div
                className="industry-image"
                style={{ backgroundImage: "url('/images/oil-gas.jpg')" }}
              >
                <div className="industry-icon">
                  <img
                    src="/images/icons/oil-gas-icon.svg"
                    alt="Oil and Gas Icon"
                  />
                </div>
              </div>
              <h3>OIL AND GAS</h3>
